...
public class CopyElementsOfVectorToArrayListExample {
  ...
  public static void main(String[] args) {
     ...
     * copy
     * index of the elements in both source and destination lists would be
     * identical.
     * 
     * The destination list must be long enough to hold all copied elements. If it
     * is
    ...
    // copy all elements of Vector to ArrayList using copy method of Collections
    // class
