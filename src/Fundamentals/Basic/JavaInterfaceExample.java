...
/**
 * Java Interface example. This Java Interface example describes how interface
 * is defined and being
 * used in Java language.
 * <p>
 * <p>
 * Syntax of defining java interface is, <modifier> interface <interface-name>{
 * //members and
 * methods() }
 */
...
interface IntExample {
   ...
   * IMPORTANT : Methods declared in the interface are implicitly public and
   * abstract.
   */
