package Fundamentals.BreakStatement;
/**
 * Java break statement with label example. This example shows how to use java
 * break statement to
 * terminate the labeled loop. The following example uses break to terminate the
 * labeled loop while
