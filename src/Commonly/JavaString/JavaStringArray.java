...
public class JavaStringArray {
    public static void main(String args[]) {
         ...
         * This method is particularly useful when we are dealing with very small size
         * array.
         */
        ...
        // Observe that giving size is mandatory here. While there was no size given in
        // the first method.
        ...
        // Note that, like every other arrays, String array starts with index 0 and not
        // index 1.

        /*
         * Retrieve values from String Array: *
         * String array elements can be retrieved by directly accessing using index. You
         * may also iterate
