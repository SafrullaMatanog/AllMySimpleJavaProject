...
public class JavaStringSplitExample {
    ...
    public static void main(String args[]) {
         ...
         * Splits the string according to given regular expression. The number of
         * resultant
        ...
        /*
         * IMPORTANT : Some special characters need to be escaped while providing them
         * as
         * delimiters like "." and "|".
         */
        ...
        /*
         * Using second argument in the String.split() method, we can control the
         * maximum
